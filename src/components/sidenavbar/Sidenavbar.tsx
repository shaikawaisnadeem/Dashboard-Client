...
const Sidenavbar = () => {
    ...
    return (
        <div className='sidenavbar'>
            {extension ? <MdKeyboardDoubleArrowRight size={25} className='double-arrow-icon' onClick={setExtension} /> :
                <MdKeyboardDoubleArrowLeft size={25} className='double-arrow-icon' onClick={setExtension} />}
            <div className='sidenavbar-icon'>
                <SiOpenai size={extension ? 40 : 60} className='spinner-icon' />
            </div>
